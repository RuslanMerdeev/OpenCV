...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=athenanichol.com&AYAH_P2=b6c0ddc6-7e0a-4db1-8ebf-cb107d7ed7b0&AYAH_F1=Lotame';
  ...
  var bkInt = setInterval(function(){
    if(document.body){
      ...
      bksrc.onload = function() {
                ...
                bk_addPageCtx("sh001", "10930640");
                bk_addPageCtx("sh001", "12644396");
